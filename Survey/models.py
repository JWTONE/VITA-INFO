...
class SurveyInfo(models.Model):
    ...
    exercise_frequency_per_week = models.CharField(choices=EXERCISE_CHOICES, max_length=20)
    average_sleep_hours_per_day = models.CharField(choices=SLEEP_CHOICES, max_length=20)
    smoking_status = models.CharField(choices=SMOKE_CHOICES, max_length=20)
    alcohol_consumption = models.CharField(choices=ALCOHOL_CHOICES, max_length=20)
